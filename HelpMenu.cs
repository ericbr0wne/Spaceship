...
public class HelpMenu
{
    public void Commands(HttpListenerResponse res)
    {
        string helpMenu = "Welcome to this help menu. \n" +
                          ...
                          "This is the command for that just switch the name to your liking and remove the backslash \n" +
                          ...
                          "and remove backslash and choose a position for your character A - C and then 1 - 3 \n" +
                          ...
                          "from the host, enter your character name, a position between A - C and 1 - 3 and remove backslash \n" +
                          ...
                          "got from your host, your id, the possition you want to attack and the enemy id and remove the backslash \n" +
