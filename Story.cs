   ...
   public void Intro(HttpListenerResponse res)
    {
        string introMessage =
            ...
            "alien enemy ships. With the knowledge of beeing in a bad shape and low on fuel and armed with only one missile. \n" +
   ...
   public void Mission(HttpListenerResponse res)
    {
        string missionMessage =
            "Welcome back commander! Your mission today is destroy the enemy ship and salvage what parts and fuel you can \n" +
